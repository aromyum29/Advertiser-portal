// @ts-nocheck
import svgPaths from "./svg-1ruwml72dw";
...
function PopUpModal() {
  return (
    <div className="absolute bg-[#ffffff] h-[433px] left-0 rounded-[8.75px] top-0 w-[784px]" data-name="pop up modal">
      <div className="h-[433px] overflow-clip relative w-[784px]">
        <ModalLayout />
        <ButtonSvg />
        <Frame21 />
      </div>
