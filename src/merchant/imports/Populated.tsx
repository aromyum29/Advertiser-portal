// @ts-nocheck
import svgPaths from "./svg-0byp0nefj8";
    ...
    <div className="bg-white h-[59.907px] min-h-[59.906978607177734px] relative rounded-[7.488px] shrink-0 w-full" data-name="Input - Container">
      <div className="flex flex-row items-center min-h-[inherit] size-full">
        <div className="content-stretch flex gap-[7.488px] items-center min-h-[inherit] px-[22.465px] py-[14.977px] relative size-full">
          <ColorModifierStroke />
          <div className="basis-0 flex flex-col font-['Inter:Regular',sans-serif] font-normal grow justify-center leading-[0] min-h-px min-w-px not-italic relative shrink-0 text-[#1f2937] text-[16.849px]">
            <p className="leading-[26.209px]">user123232</p>
          </div>
        </div>
      </div>
    </div>
...
function TextInput() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-[calc(50%+0.06px)] top-0 translate-x-[-50%] w-[359.442px]" data-name="Text input">
      <LabelTopContainer />
      <InputContainer />
    </div>
  );
    ...
    <div className="bg-white h-[59.907px] min-h-[59.906978607177734px] relative rounded-[7.488px] shrink-0 w-full" data-name="Input - Container">
      <div className="flex flex-row items-center min-h-[inherit] size-full">
        <div className="content-stretch flex gap-[7.488px] items-center min-h-[inherit] px-[22.465px] py-[14.977px] relative size-full">
          ...
          <div className="basis-0 flex flex-col font-['Inter:Regular',sans-serif] font-normal grow justify-center leading-[0] min-h-px min-w-px not-italic relative shrink-0 text-[#1f2937] text-[16.849px]">
            <p className="leading-[26.209px]">••••••••••••••</p>
          </div>
        </div>
      </div>
    </div>
...
function ColorModifier() {
  return <div className="absolute bg-[#1f2836] inset-0" data-name="color-modifier" />;
}
...
function LoginForm() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col gap-[31.826px] h-[587.57px] items-center left-[calc(50%+0.44px)] overflow-clip px-[59.907px] py-[24.337px] rounded-[18.721px] top-[calc(50%+0.45px)] translate-x-[-50%] translate-y-[-50%] w-[436.88px]" data-name="Login form">
      <Header />
      <Frame />
      <PrimaryCta />
      <Hyperlinks />
...
export default function Populated() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative size-full" data-name="Populated">
      <Login />
    </div>
  );
}